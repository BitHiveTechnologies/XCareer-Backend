...
async function testEmailService() {
    ...
    try {
        ...
        const upgradeSuccess = await emailService_1.emailService.sendSubscriptionUpgradeEmail(testEmailReal, 'Test User', 'premium', ['Ad-free experience', 'Priority support', 'All templates']);
        ;
        ...
        const credsSuccess = await emailService_1.emailService.sendSubscriptionWelcomeCredentialsEmail(testEmailReal, 'Test User', 'temp-pass-123', 'basic');
        ;
        ...
        const expirySuccess = await emailService_1.emailService.sendSubscriptionExpiryEmail(testEmailReal, 'Test User', 'premium', 7);
        ;
        ...
        const passwordSuccess = await emailService_1.emailService.sendPasswordChangedEmail(testEmailReal, 'Test User');
        ;
